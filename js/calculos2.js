...
function mostrarLista(id, personaje, aldea, clan, poder, vidas) {
    ...
    addChild(lista, 'li', estilosLista(strong,personaje,"Personaje"));
    addChild(lista, 'li', estilosLista(strong,aldea,"Aldea"));
    addChild(lista, 'li', estilosLista(strong,clan,"Clan"));
    addChild(lista, 'li', estilosLista(strong,poder,"Poder"));
    addChild(lista, 'li', estilosLista(strong,vidas,"Vidas"));

}

function addChild(elemento, tag1, contenido1) {
    item = document.createElement(tag1);
    item.innerHTML = contenido1;
    lista.appendChild(elemento);
}


function estilosLista(tag2,inner, contenido2) {
    var estilo = document.createElement(tag2);
    estilo.innerHtml = inner+":"
    var todo = estilo.outerHTML + contenido2;
    return todo;
}